...
/** getCommentByQuestionId GET /api/comment/get/questonCommnet */
export async function getCommentByQuestionIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getCommentByQuestionIdUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseListCommentVO_>('/api/comment/get/questonCommnet', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listMyCommentsUsingPost(options?: { [key: string]: any }) {

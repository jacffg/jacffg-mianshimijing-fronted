      ...
      <div id="bankPage" className="max-width-content">
        ...
        />
          ...
          >
            ...
            <span style={{ fontSize: 20, fontWeight: "bold", color: "#3c3c3c" }}>
                🔗 分享此题库
            </span>
                  </div>
            ...
            <span style={{ fontSize: 16, fontWeight: 500, color: "#595959" }}>
                分享链接：
                      ...
                      <div style={{ display: "flex", alignItems: "center", marginTop: 8 }}>
                          ...
                          />
                          <Button type="primary" onClick={handleCopy} style={{ padding: "0 16px" }}>
                              复制
                          </Button>
                      </div>
                  </div>
                  ...
                  {/* 二维码部分 */}
                  <div>
                      <div style={{ fontSize: 16, fontWeight: 500, color: "#595959", marginBottom: 16 }}>
                          二维码分享：
                      </div>
